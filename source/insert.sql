...
INSERT INTO pagamentos (num_trans_pagamento, num_consumidor, id_funcionario, tipo_pagamento, quantia_pagamento, data_pagamento, status_pagamento, num_banco, num_agencia_banco, num_cheque, num_cartao_credito, data_exp_cartao, tipo_pagamento_cartao)
VALUES (1, 1, 1, 'cartao', 6, '2019-10-23', '1', 1, '123', null, 1, '2025-01-01', 'debito'),
(2, 2, 1, 'cartao', 6, '2019-10-23', '1', 1, '345', null, 2, '2025-01-02', 'debito'),
(3, 3, 3, 'cartao', 5, '2019-10-30', '1', 1, '567', null, 3, '2025-01-03', 'credito'),
(4, 4, 3, 'cartao', 5, '2019-10-30', '1', 1, '789', null, 4, '2025-01-05', 'debito'),
(5, 5, 5, 'cartao', 5, '2019-10-30', '1', 1, '321', null, 5, '2025-01-06', 'credito'),
(6, 6, 5, 'cartao', 5, '2019-10-30', '1', 1, '213', null, 6, '2025-01-07', 'credito'),
(7, 7, 7, 'cartao', 5, '2019-10-30', '1', 1, '412', null, 7, '2025-01-08', 'credito'),
(8, 8, 7, 'cartao', 5, '2019-10-30', '1', 1, '526', null, 8, '2025-01-09', 'credito'),
(9, 9, 9, 'cartao', 7, '2019-10-30', '1', 1, '333', null, 9, '2025-01-10', 'credito'),
(10, 10, 10, 'cartao', 5, '2019-10-30', '1', 1, '111', null, 10, '2025-01-11', 'debito');

INSERT INTO aluguel_filmes (num_aluguel_filme, id_funcionario, num_copia_filme, num_cliente, num_trans_pagamento, data_aluguel_filme, data_retorno_filme, status_aluguel_filme, taxa_aluguel_filme, sobretaxa_aluguel_filme, feedback_cliente)
VALUES (1, 1, 1, 1, 1, '2019-10-23', '2019-10-27', '1', 0, 0, 'bom'),
(2, 1, 2, 2, 2, '2019-10-23', '2019-10-27', '1', 0, 0, 'otimo'),
(3, 3, 3, 3, 3, '2019-10-30', '2019-11-03', '1', 0, 0, 'excelente'),
(4, 3, 4, 4, 4, '2019-10-30', '2019-11-03', '1', 0, 0, 'ruim'),
(5, 5, 5, 5, 5, '2019-10-30', '2019-11-03', '1', 0, 0, 'bom'),
(6, 5, 6, 6, 6, '2019-10-30', '2019-11-03', '1', 0, 0, 'bom'),
(7, 7, 7, 7, 7, '2019-10-30', '2019-11-03', '1', 0, 0, 'bom'),
(8, 7, 8, 8, 8, '2019-10-30', '2019-11-03', '1', 0, 0, 'bom'),
(9, 9, 9, 9, 9, '2019-10-30', '2019-11-03', '1', 0, 0, 'otimo'),
(10, 10, 11, 10, 10, '2019-10-30', '2019-11-03', '1', 0, 0, 'ruim');
